        ...
        <div class="card-body">
            <form action="{{ route('papers.update', $paper->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="title" id="title" class="form-control" placeholder="Judul Paper" required>{{ $paper->title }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="authors" id="authors" class="form-control" placeholder="Penulis (pisahkan dengan koma)" required>{{ $paper->authors }}</textarea>
                    </div>
                </div>
