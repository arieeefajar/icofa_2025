        ...
        <div class="card-body">
            <form action="{{ route('panels.update', $panel->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="description" id="description" class="form-control" placeholder="Deskripsi (opsional)">{{ $panel->description ?? '' }}</textarea>
                    </div>
                </div>
                            ...
                            @foreach ($moderators as $index => $mod)
                                <div class="input-group mb-2 moderator-group">
                                    <input type="text" name="moderator[]" class="form-control"
                                        value="{{ $mod }}" placeholder="Nama Moderator" required>

                                    @if ($index == 0)
                                        <button type="button" class="btn btn-outline-primary add-moderator"><i
                                                class="bx bx-plus"></i></button>
                                    @else
                                        <button type="button" class="btn btn-outline-danger remove-moderator"><i
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="time_zone" class="form-control" id="time_zone"
                            placeholder="Western Indonesian Time (WIB) [GMT +7]" value="{{ $panel->time_zone ?? '' }}">
                    </div>
                </div>
                {{-- Type --}}
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="type" id="type" class="form-control">
                            <option value="offline" {{ $panel->type == 'offline' ? 'selected' : '' }}>Offline</option>
                            <option value="online" {{ $panel->type == 'online' ? 'selected' : '' }}>Online</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3 optional-fieldd">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="room_name" class="form-control" id="room_name"
                            placeholder="Marlin VIP 1 (Offline)" required value="{{ $panel->room ?? '' }}">
                    </div>
                </div>
                <div class="row mb-3 optional-field">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="room" class="form-control" id="room"
                            placeholder="Sayuwiwit IV (Online - Zoom - Breakout Room 3)" value="{{ $panel->room ?? '' }}">
                    </div>
                </div>
                ...
                <div class="row mb-3 optional-field">
                    ...
                    <div class="col-sm-10">
                        <input type="url" name="zoom_link" class="form-control" id="zoom_link"
                            placeholder="https://zoom.us/..." value="{{ $panel->zoom_link ?? '' }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3 optional-field">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="meeting_id" class="form-control" id="meeting_id"
                            placeholder="123 4567 8910" value="{{ $panel->meeting_id ?? '' }}" />
                    </div>
                </div>
                ...
                <div class="row mb-3 optional-field">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="password" class="form-control" id="password"
                            placeholder="Password Zoom (opsional)" value="{{ $panel->password ?? '' }}" />
                    </div>
                </div>
